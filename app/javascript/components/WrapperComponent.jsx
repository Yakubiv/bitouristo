    ...
    return (
      <div>
        <nav className="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-0">
          <a className="navbar-brand col-sm-3 col-md-2 mr-0" href="#">Bitouristo</a>
          ...
          <div className="row">
            <div className="col-md-2 d-none d-md-block bg-light sidebar">
              <div className="sidebar-sticky">
                <SidebarComponent items_list={['Tours', 'Rewards', 'Images', 'Settings']} setComponent={this._setComponent} activeComponent={this._activeComponent()}/>
              </div>
            </div>
